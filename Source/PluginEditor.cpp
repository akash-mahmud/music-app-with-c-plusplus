...
MusicAppAudioProcessorEditor::~MusicAppAudioProcessorEditor()
{
}
...
void MusicAppAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    g.setFont (15.0f);
    g.drawFittedText ("Akash C++ project Music App with Juice frame work", getLocalBounds(), juce::Justification::centred, 1);
}
