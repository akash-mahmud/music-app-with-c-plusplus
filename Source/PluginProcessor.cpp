...
//==============================================================================
const juce::String MusicAppAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool MusicAppAudioProcessor::acceptsMidi() const
{
...
bool MusicAppAudioProcessor::producesMidi() const
{
...
bool MusicAppAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double MusicAppAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int MusicAppAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int MusicAppAudioProcessor::getCurrentProgram()
{
    return 0;
}

void MusicAppAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String MusicAppAudioProcessor::getProgramName (int index)
{
    return {};
}

void MusicAppAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void MusicAppAudioProcessor::releaseResources()
{
...
void MusicAppAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool MusicAppAudioProcessor::hasEditor() const
{
...
MusicAppAudioProcessor::createParameterLayout()
